...
const PreviewAndEdit: React.FC<HelperProps> = ({ isWizardMode, setIsWizardMode, setHelperPageIndex }) => {
    ...
    useEffect(() => {
        ...
        if (!selectedImageURL) {
            ...
            setSelectedImageURL(preSelectedImageId, preSelectedImageDescription, preSelectedImageURL, preSelectedImageDownloadURL)
        }
    ...
    return(
        <div className='w-full'>
            ...
            >
                    {JSONStore.isLoading && ( 
                        <Skeleton className='absolute bg-gray-50 z-10 top-0 left-0 h-full w-full flex ' />
                    )}
                        ...
                        <div className="w-full h-full flex flex-col p-2 max-w-[300px] items-center" id="main-content">
                            ...
                            <div id="title" className='relative text-center h-full w-full'>
                                ...
                                <div className='absolute rotate-[-1deg] skew-[-2deg]'>
                                    {GPTObject && (
                                        <div style={{ boxShadow: `7px 0 0 0 ${orgData.colors.colorPrimary}`, backgroundColor: orgData.colors.colorPrimary }} className={`font-serif pr-0 box-decoration-clone text-[24px] leading-[30px] whitespace-pre-wrap p-[6px] inline opacity-50 text-white`}>
                                            {GPTObject?.title}
                                        </div>
                                    )}
                                </div>
                            ...
                            <div id="subtitle" className='relative text-center h-full w-full'>
                                ...
                                <div className='absolute bottom-2'>
                                    {GPTObject && (
                                        <div style={{ boxShadow: `7px 0 0 0 ${orgData.colors.colorSecondary}`, backgroundColor: orgData.colors.colorSecondary }}  className={`font-serif pr-0 box-decoration-clone text-[14px] leading-[21px] whitespace-pre-wrap p-[6px] inline opacity-60 text-white`}>
                                            {GPTObject?.subtitle}
                                        </div>
                                    )}
                                </div>
