    ...
    <Dialog.Root open={open} onOpenChange={setOpen}>
      <div className="photo-preview flex flex-auto gap-1 md:gap-3 justify-center ">
        ...
        {['9/16', '1/1', '4/3', '16/9'].map((aspectRatio, index) => (
          <Dialog.Trigger
            onClick={() => handleThumbnailClick(aspectRatio)}
            ...
            {selectedImageURL && (
              <>
                <img
                  ...
                  alt={'Selected Photo'}
                />
                <div className="w-auto h-auto bg-black text-white absolute right-0 bottom-0 text-xs p-1">
                  {aspectRatio}
                </div>
              </>
            )}
      ...
      <Dialog.Portal>
        ...
        >
          <Dialog.Title className="text-white p-2">Your selected image</Dialog.Title>
          {selectedImageURL && (
            <img
