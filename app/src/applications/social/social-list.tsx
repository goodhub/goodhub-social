  ...
  return (
    <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-4">
      <Card className="w-full flex flex-col bg-orange-100 justify-between h-full">
        ...
        <CardContent>
          <p>
            Dribble your way to the Meadows Community Centre next Sat for our basketball comp – only £5/team & FREE for
            spectators! Food and drink available, and music by DJ Pulley. #HoopsForHope
          </p>
        </CardContent>
        <CardFooter className="flex">
          <div className="flex gap-1 w-full justify-end">
            <Button type="submit" variant="outline" className="rounded-full ml-2 py-0 px-2 h-7">
              Change when or where to post
            </Button>
          </div>
        </CardFooter>
      </Card>
      <Card className="w-full">
        <CardHeader>
          <CardDescription className="text-base inline-block mt-2 italic">Posted: Last Friday</CardDescription>
          <img alt="" src="https://www.goodhub.org.uk/post_example.png" />
        </CardHeader>
        <CardContent>
          <p>
            If you would like to make a donation to the Meadows Foodbank over the next couple of weeks, our most needed
            items are Cereal, Coffee, Squash, Tinned Fruit, Shampoo. Thank you for your continued support
            #MeadowsFoodbank
          </p>
        </CardContent>
        <CardFooter>
