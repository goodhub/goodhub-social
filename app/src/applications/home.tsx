          ...
          <img className='w-full h-28 md:h-36 object-cover rounded-xl aspect-video mb-4' src='https://www.goodhub.org.uk/organisations_hero_small.jpg' />
            <div className="grid w-full items-center gap-4 ">
              <div className="flex flex-col space-y-1.5">
                ...
                <Input className='text-base md:text-lg' id="email" type="email" placeholder="Your email address" value={email} onChange={(e) => setEmail(e.target.value)}/>
              </div>
              <div className="flex flex-col space-y-1.5">
                <Label className='text-base md:text-lg' htmlFor="password">Password</Label>
                <Input className='text-base md:text-lg' id="password" type="password" placeholder="Password"  value={password} onChange={(e) => setPassword(e.target.value)}/>
              </div>
            </div>
          
        </CardContent>
        <CardFooter className="flex justify-end px-4 md:px-6">
          <Button className='text-base md:text-lg' type="submit">Sign in</Button>
        </CardFooter>
        </form>
      </Card>
       ) : (   
